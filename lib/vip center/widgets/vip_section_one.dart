...
import 'package:m2/vip%20center/models/feature_model.dart';
import 'package:m2/vip%20center/widgets/feature_item.dart';
...
class _VipSectionOneState extends State<VipSectionOne> {
  List<FeatureModel> featurs = [
    FeatureModel(
        featureIcon: "assets/vip_icon/1.png",
        featureLable: "مؤثرات الدخول",
        active: true),
    FeatureModel(
        featureIcon: "assets/vip_icon/2.png",
        featureLable: "براويز مميزة ",
        active: true),
    FeatureModel(
        featureIcon: "assets/vip_icon/3.png",
        featureLable: "ايقونة ",
        active: true),
    FeatureModel(
        featureIcon: "assets/vip_icon/4.png",
        featureLable: "مؤثرات الدخول",
        active: true),
    FeatureModel(
        featureIcon: "assets/vip_icon/5.png",
        featureLable: "مؤثرات الدخول",
        active: true),
    FeatureModel(
        featureIcon: "assets/vip_icon/6.png",
        featureLable: "مؤثرات الدخول",
        active: true),
    FeatureModel(
        featureIcon: "assets/vip_icon/1.png",
        ...
        SizedBox(
          ...
          child: Center(
            child: SizedBox(
                ...
                child: const Image(image: AssetImage("assets/images/1b.png"))),
          ),
        ),
        Expanded(
          child: ClipPath(
